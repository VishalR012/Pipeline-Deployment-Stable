...
def makeApiCallAndGetResponse(String taskID, String args_paramsJson) {
    ...
    post.setRequestProperty("x-rdp-tenantId", tempparams[0].xrdptenantid)
    post.setRequestProperty("x-rdp-clientId", "rdpclient")
    post.setRequestProperty("x-rdp-userId", tempparams[0].xrdpuserid)
    post.setRequestProperty("x-rdp-userRoles", tempparams[0].xrdpuserrole)
    post.setRequestProperty("auth-client-id", tempparams[0].authclientid)
    post.setRequestProperty("auth-client-secret", tempparams[0].authclientsecret)
